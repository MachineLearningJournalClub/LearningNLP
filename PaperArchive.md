<h1 align="center">NLP Paper Archive</h1>
    ...
    <li>
      ...
      <ul>
        <li><a href="#word-embedding">Word embedding</a></li>
          <ul>
        <li><a href="#why-can-computers-understand-natural-language">Why Can Computers Understand Natural Language</a></li>
          </ul>
      </ul>
    </li>
  </ol>
...
## [Why Can Computers Understand Natural Language](https://www.researchgate.net/publication/341393890_Why_Can_Computers_Understand_Natural_Language_The_Structuralist_Image_of_Language_Behind_Word_Embeddings)
